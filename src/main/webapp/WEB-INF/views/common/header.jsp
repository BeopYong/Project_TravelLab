...
div.login-container table#logged-in input[type=button] {
	border-radius: 3px;
}
</style>
<link rel="stylesheet"
...
<body>
	<div id="container">
		<header>
			<h1 class="logo" style="font-family: 'yg-jalnan';"font-size: 3em;">Travle
				lab</h1>
			<div class="login-container">
				...
				<form id="loginFrm"
					...
					<table>
						<tr>
							<td><input type="text" style="font-family: 'OTWelcomeRA';"
								name="memberId" id="memberId" placeholder="아이디" tabindex="1"
								value="<%=saveMemberId != null ? saveMemberId : ""%>"></td>
							<td><input type="submit" style="font-family: 'OTWelcomeRA';"
								value="로그인" tabindex="3"></td>
						</tr>
						<tr>
							<td><input type="password" style="" name="password"
								id="password" placeholder="비밀번호" tabindex="2"></td>
							<td></td>
						</tr>
						<tr>
							<td colspan="2"><input type="checkbox" name="saveId"
								id="saveId" <%=saveMemberId != null ? "checked" : ""%> /> <label
								for="saveId" style="font-family: 'OTWelcomeRA';">아이디저장</label>&nbsp;&nbsp;
				...
				<table id="login">
					<tr>
						<td style="font-family: 'OTWelcomeRA';"><%=loginMember.getMemberName()%>님,
							안녕하세요.</td>
					</tr>
					<tr>
						<td><input type="button"
							color:#888888; background:#FDFDFD; value="내정보보기"
							style="font-family: 'OTWelcomeRA';"
							onclick="location.href='<%=request.getContextPath()%>/member/myPage';">
							<input type="button"
							color:#888888; background:#FDFDFD; value="로그아웃"
							style="font-family: 'OTWelcomeRA';"
			...
			<div class="traffic-hheader">
				<nav class="thn">
					<ul>
						<li class="link"><a href="<%=request.getContextPath()%>"
							style="font-family: 'OTWelcomeRA';">Home</a></li>
						<li class="link" style="font-family: 'OTWelcomeRA';"><a
							href="<%=request.getContextPath()%>/product/productMain">상품</a></li>
						<li class="link" style="font-family: 'OTWelcomeRA';"><a
							href="<%=request.getContextPath()%>/magazine/magazineList">Magazine</a></li>
						<li class="link" style="font-family: 'OTWelcomeRA';"><a
