					...
					<table id="login">
						...
						<tr>
							<td>
								...
								<input type="button" color:#888888; background:#FDFDFD; value="상품 등록" style="font-family: 'OTWelcomeRA';" onclick="location.href='<%= request.getContextPath() %>/product/productTest';">
							</td>
						</tr>
					</table>
<% } %>
