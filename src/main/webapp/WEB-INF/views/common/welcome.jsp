...
/* BG */
	...
	/* Set your background with this */
		...
		background: #F3EBE8 url("images/travel.jpg") bottom left;
...
<!-- <noscript>
	<link rel="stylesheet" href="main/assets/css/noscript.css" />
</noscript> -->
</head>
<body class="is-preload">
	<div id="wrapper">
		<div id="bg">
			<img src="<%=request.getContextPath() %>/images/bg/travel.jpg" alt="" />
		</div>
		<div id="overlay"></div>
		<div id="main">
			...
			<header id="header">
				...
				<p>법정팀</p>
				<p>
					<b>조정우 &nbsp;&bull;&nbsp;</b> <b>유법용 &nbsp;&bull;&nbsp;</b> <b>이혜미
						&nbsp;&bull;&nbsp;</b> <b>전혜린 &nbsp;&bull;&nbsp;</b> <b>고정현</b>
				</p>
				<nav>
					<ul>
					</ul>
			...
			<!-- Footer -->
			<footer id="footer">
				<span class="copyright">Travel Lab</span>
			</footer>
