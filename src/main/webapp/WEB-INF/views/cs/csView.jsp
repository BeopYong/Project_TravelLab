...
%>
				<tr>
					...
					<td>
						<%-- 첨부파일이 있을경우만, 이미지와 함께 original파일명 표시 --%> <a
...
%>
				<tr>
					<th
						style="text-align: center; background-color: #d6dde8; vertical-align: middle;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;내
						용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th>
					<td colspan="2"
			...
			<tr>
				...
				<th colspan="2">
					<!-- <input type="button" value="수정하기" onclick="updateCs()">  --> <input
					type="button" value="삭제하기" onclick="deleteCs()">
				</th>
			</tr>
			<% 	} %>
		</table>
			...
			<div class="comment-editor">
				<form action="<%=request.getContextPath()%>/cs/csCommentEnroll"
					...
					<button type="submit" id="btn-comment-enroll1"
						style="vertical-align: middle;">등록</button>
				</form>
			</div>
			<!--게시판 댓글!-->
			<% 
...
%>
				...
				<tr class="level1">
					...
					<br /> <%= cc.getContent() %></td>
					<td>
						<button class="btn-reply" value="<%= cc.getNo() %>">답글</button> <% if(removable){ %>
