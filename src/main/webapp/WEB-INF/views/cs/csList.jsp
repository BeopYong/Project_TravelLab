...
<body>
	<div>
		...
		<p align="center" style="font-family: 'paybooc-Bold';">Q&A 1:1문의
			트래블 랩 서비스의 오류, 장애, 기타 공지사항을 안내드립니다.</p>
	</div>
		...
		<div class="row">
			<table class="table table-hover"
				...
				<thead>
					<tr>
						<th
							style="background-color: #d6dde8; text-align: center; width: 15%;">번호</th>
						<th
							style="background-color: #d6dde8; text-align: center; width: 45%">제목</th>
...
%>
					<tr>
						<td><%=cs.getNo()%></td>
						<td style="text-align: justify;">[<%=cs.getOptions()%>] <a
							href="<%=request.getContextPath()%>/cs/csView?no=<%=cs.getNo()%>"><%= cs.getTitle()%></a>
						</td>
						<td><%=cs.getWriter()%></td>
						<td><%=cs.getRegDate()%></td>
					</tr>
