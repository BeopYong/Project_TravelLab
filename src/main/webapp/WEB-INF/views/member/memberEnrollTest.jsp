...
<body>
							...
							<fieldset id="signUpForm">
								<div class="wrap-input100">
									<span class="label-input100">Id *</span> <input
										...
										required placeholder="Enter your Id"> <span
								...
								<div class="wrap-input100 ">
									<span class="label-input100">Password *</span> <input
										...
										required placeholder="Enter your password"> <span
										class="focus-input100"></span>
								</div>
								<div>
								...
								<div class="wrap-input100">
									<span class="label-input100">PasswordCheck *</span> <input
										class="input100" type="password" name="passwordChk"
										id="passwordChk" required placeholder="Check your password">
								...
								<div class="wrap-input100">
									<span class="label-input100">Name *</span> <input
										...
										required placeholder="Enter your Name"> <span
										class="focus-input100"></span>
								</div>
								<div>
								...
								<div class="wrap-input100" data-validate="Name is required">
									<span class="label-input100">PhoneNumber *</span> <input
										class="input100" type="text" name="tel" id="tel" required
								...
								<div class="wrap-input100">
									<span class="label-input100">Email *</span> <input
										class="input100" type="text" name="email" id="email" required
										placeholder="Enter your email addess"> <span
										class="focus-input100"></span>
								</div>
								<div>
								...
								<div class="wrap-input100 ">
									<span class="label-input100">PayCode</span> <input
										...
										placeholder="Enter your payCode"> <span
										class="focus-input100"></span>
								</div>
								<div>
								...
								<div class="wrap-contact100-form-btn">
									<div class="contact100-form-bgbtn"></div>
									<button class="contact100-form-btn" id="resetButton"
	...
	<script>
		    ...
		    $("#email").focusin(function() {
		    	const bool = $("#password").val()==$("#passwordChk").val()
		    	if(bool)
		    		$(".confirm").html("&nbsp;");
		    });
