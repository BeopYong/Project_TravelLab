...
<section id=profile-container>
	...
	<body>
		<form id="profileUpdateFrm" name="profileEnrollFrm"
			...
			<table id="tbl-profile-view" align="center">
				<thead>
					<th align="center" colspan="2"><%= loginMember.getMemberName() %>님의
						프로필</th>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						<td align="center"><img
							src="https://api.cdn.visitjeju.net/photomng/thumbnailpath/202110/21/40916b0e-7ce7-4c3f-8ad1-59aeef46d4c6.png" /></td>
					</tr>
					<tr>
