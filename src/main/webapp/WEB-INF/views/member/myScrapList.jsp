		...
		<div class="w3-row-padding">
			...
			<div class="w3-third w3-container w3-margin-bottom">
				...
				<div class="w3-container w3-white">
					...
					<p class="p-explain">
						서귀포시 신효동 위치한 국수 전문점 <br>
						<br>#전설칼국수 #보말칼국수 #문어비빔국수
					</p>
				</div>
			</div>
			<div class="w3-third w3-container w3-margin-bottom">
				...
				<div class="w3-container w3-white">
					...
					<p class="p-explain">
						해녀가 직접 잡아온 해산물로 요리하는집<br>
						<br>#해물라면 #해산물 조림 #해산물 구이 #해물뚝배기
					</p>
				</div>
			</div>
			<div class="w3-third w3-container w3-margin-bottom">
				...
				<div class="w3-container w3-white">
					...
					<p class="p-explain">
						Korea Jeju Top10선정 맛집 <br>
						<br>#제주 #전복돌솥밥 #전복구이 #전복죽 #전복 끝판왕
					</p>
				</div>
			</div>
			<div class="w3-third w3-container w3-margin-bottom">
