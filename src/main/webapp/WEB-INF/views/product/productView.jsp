		...
		<div class="product-info-box">
			<table>
				<tr>
					<th>상품명</th>
					<td colspan="2">
						<p><%=product.getP_name() %></p> <input type="hidden"
				...
				<tr>
					<th>지역</th>
					<td colspan="2">
						<p name="region"><%= product.getRegion() %></p> <input
						type="hidden" name="region" value="<%=product.getRegion()%>" />
					</td>
				</tr>
				<tr>
					<th>가격</th>
             ...
             -->
				...
				<tr>
					<td><label for="">총 결제금액 : </label> <input type="text"
						name="product_bill" readonly></td>
				</tr>
				<!-- 
             ...
             -->
				...
				<tr>
					<td colspan="3"><div class="product-info">
...
<div class="btnbox">
	<button type="button" class="btn btn-primary btn-lg" id="btn">바로
		결제</button>
...
<table>
	<tr>
		...
		<th colspan="2"><input type="button" value="수정하기"
			onclick="updateProduct()"><input type="button" value="삭제하기"
			onclick="deleteProduct()"></th>
	</tr>
</table>
<%
}
