...
$(p_category).change((e) => {
	...
	<table>
		<tr>
			...
			<td><a
				href="<%=request.getContextPath()%>/product/productList?p_category=101">더
					보기</a></td>
		</tr>
	</table>
	...
	<table>
		<tr>
			...
			<td><a
				href="<%=request.getContextPath()%>/product/productList?p_category=301">더
					보기</a></td>
		</tr>
	</table>
	...
	<table class="product-table">
		<tr>
			...
			<td><a
				href="<%=request.getContextPath()%>/product/productList?p_category=302">더
					보기</a></td>
		</tr>
	</table>
	<div class="container">
	...
	<table>
		<tr>
			<td><a href="<%=request.getContextPath()%>/product/productTest">상품
					등록</a></td>
		</tr>
	</table>
