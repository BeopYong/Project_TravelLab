	...
	<div class="row justify-content-end">
		<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate" style="display: block; margin: auto;">
			<div class="cart-total mb-3">
				<h3>BILL</h3>
				<p class="d-flex">
					<span><strong>주문자</strong></span>
					<span><strong><%=loginMember.getMemberId()%></strong></span>
				</p>
				<p class="d-flex">
					<span><strong>OrderCode</strong></span>
					<span style="color: red;"><strong>123456</strong></span>
				</p>
				<hr>
				<p class="d-flex total-price">
					<span style="width: 100%; text-align: center;" >주문이 정상적으로 처리되었습니다.</span>
				</p>
			</div>
			<p class="text-center"><button onclick="location.href='<%=request.getContextPath()%>/member/payment'" class="btn btn-primary py-3 px-4">Confirm</button></p>
		</div>
	</div>
